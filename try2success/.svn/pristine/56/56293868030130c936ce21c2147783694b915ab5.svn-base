...
namespace hoachdinhtuonglai.Data.Core
{
    ...
    public static class ConnectionPP
    {
        static readonly string connectionString = @"workstation id=hoachdinhtuonglai.mssql.somee.com;packet size=4096;user id=hdtl;pwd=123asdzxc;data source=hoachdinhtuonglai.mssql.somee.com;persist security info=False;initial catalog=hoachdinhtuonglai";
        static readonly string connectionString2 = @"Data Source=112.213.84.121;Initial Catalog=hdtl;Persist Security Info=True;User ID=hdtl;Password=hdtl123!@#";
        //"Data Source=dangkhoa-pc;Initial Catalog=hdtl;Persist Security Info=True;User ID=hdtl;Password=123asdzxc";

        public static Database getConnection()
        {
            Database db =new Database(connectionString2, "System.Data.SqlClient");
            try
            {
        ...
        public static IDbConnection ConnectionPublic()
        {

            return new Database(connectionString, "System.Data.SqlClient").Connection;
        }
    }
