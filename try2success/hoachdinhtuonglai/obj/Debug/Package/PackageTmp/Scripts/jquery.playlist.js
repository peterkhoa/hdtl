...
//	    playlistItem++;
//	});
//	var strhtml = playlist.html();
//	//playlist.html("<div class='jw_playlist_width'>" + strhtml + "</div>");
//}
...
function populatePlaylist(player, jsPlaylist, playlist) {
    ...
    var len = 80 * i;
    var strhtml = playlist.html();
    playlist.html("<div style='width:" + len + "px'>" + strhtml + "</div>");    
    var playlistItem = 0;
    playlist.children().children().each(function () {
        var currentItem = playlistItem;
